    ...
    return (
        <div className="h-full flex flex-col bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-700">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
                ...
                <TabsContent value="comments" className="flex-1 overflow-y-auto scrollbar-hide p-0 mt-0 max-h-[calc(100vh-250px)]">
                ...
                <TabsContent value="transactions" className="flex-1 overflow-y-auto scrollbar-hide p-6 mt-0 max-h-[calc(100vh-250px)]" data-vendor-transactions-scroll-container>
                    {loading ? (
                ...
                <TabsContent value="statement" className="flex-1 overflow-y-auto scrollbar-hide p-0 mt-0 max-h-[calc(100vh-250px)]">
                                        ...
                                        <table className="w-full text-sm">
                                            <thead className="bg-slate-50 sticky top-0 z-10">
                                                <tr className="border-b border-slate-200">
                                                    ...
                                                    <th className="px-3 py-3 text-right font-semibold">Payables</th>
                                                    <th className="px-3 py-3 text-right font-semibold">Unused Credits</th>
                                                </tr>
                                            </thead>
