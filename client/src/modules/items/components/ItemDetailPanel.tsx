...
export default function ItemDetailPanel({ item, onClose, onEdit, onClone, onToggleActive, onDelete }: ItemDetailPanelProps) {
  ...
  const transactions = sampleTransactions.filter(t => {
    const typeMatch = t.type === filterBy;
  ...
  return (
    <div className="h-full flex flex-col bg-white border-l border-slate-200">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="overview" className="flex-1 overflow-y-auto scrollbar-hide p-6 mt-0 max-h-[calc(100vh-250px)]">
        ...
        <TabsContent value="transactions" className="flex-1 overflow-y-auto scrollbar-hide mt-0 max-h-[calc(100vh-250px)]">
        ...
        <TabsContent value="history" className="flex-1 overflow-y-auto scrollbar-hide mt-0 max-h-[calc(100vh-250px)]">
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50/80">
